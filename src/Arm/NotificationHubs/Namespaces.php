...
class Namespaces
{
    ...
    public function createOrUpdateAsync($resourceGroupName, $namespaceName, array $parameters, array $customHeaders = [])
    {
        ...
        if ($namespaceName == null) {
            PhpValidate::notNullOrEmpty($namespaceName, '$namespaceName');
        }
        if ($parameters == null) {
            PhpValidate::notNullOrEmpty($parameters, '$parameters');
        }
    ...
    public function createOrUpdateAuthorizationRuleAsync($resourceGroupName, $namespaceName, $authorizationRuleName, array $parameters, array $customHeaders = [])
    {
        ...
        if ($authorizationRuleName == null) {
            PhpValidate::notNullOrEmpty($authorizationRuleName, '$authorizationRuleName');
        }
        if ($parameters == null) {
            PhpValidate::notNullOrEmpty($parameters, '$parameters');
        }
    ...
    public function getLongRunningOperationStatusAsync($operationStatusLink, array $customHeaders = [])
    {
        if ($operationStatusLink == null) {
            PhpValidate::notNullOrEmpty($operationStatusLink, '$operationStatusLink');
        }
