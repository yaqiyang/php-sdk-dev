 ...
 */
class NetworkManagementClient extends PhpRestServiceClient
{
    /**
    ...
    {
        $queryParams = [PhpResources::API_VERSION => '2016-06-01', 'monitor' => 'true'];
    ...
    public function awaitAsync($response)
    {
       ...
       public function checkDnsNameAvailabilityAsync($location, $domainNameLabel = null, array $customHeaders = [])
       {
           ...
           if ($subscriptionId == null) {
               PhpValidate::notNullOrEmpty($subscriptionId, '$subscriptionId');
           }
