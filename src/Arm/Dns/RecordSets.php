...
class RecordSets
{
    ...
    public function updateAsync($resourceGroupName, $zoneName, $relativeRecordSetName, array $recordType, array $parameters, $ifMatch = null, $ifNoneMatch = null, array $customHeaders = [])
    {
        ...
        if ($zoneName == null) {
            PhpValidate::notNullOrEmpty($zoneName, '$zoneName');
        }
        if ($relativeRecordSetName == null) {
            PhpValidate::notNullOrEmpty($relativeRecordSetName, '$relativeRecordSetName');
        }
        if ($recordType == null) {
            PhpValidate::notNullOrEmpty($recordType, '$recordType');
        }
        if ($parameters == null) {
